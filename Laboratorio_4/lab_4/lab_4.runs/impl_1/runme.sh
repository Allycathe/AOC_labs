...
HD_PWD='D:/AOC/Laboratorio_4/lab_4/lab_4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log scoreboard.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source scoreboard.tcl -notrace
